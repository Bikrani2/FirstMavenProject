...
public class PersonService {
    ...
    public static Set<Person> removeBobWithoutIterator() {
        ...
        people.add(Person.builder().firstName("manal").familyName("alica").build());
        people.add(Person.builder().firstName("safae").familyName("Bob").build());
        people.add(Person.builder().firstName("douae").familyName("Charlie").build());
